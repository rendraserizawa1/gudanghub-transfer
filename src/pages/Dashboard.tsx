    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="card">
          ...
          <p className="text-2xl font-black text-gray-900 mt-1">{transfers.length}</p>
        </div>

        <div className="card">
          <p className="text-xs text-gray-500">Dalam Perjalanan</p>
          <p className="text-2xl font-black text-warning-600 mt-1">{inTransitCount}</p>
        </div>

        <div className="card">
          <p className="text-xs text-gray-500">Ada Selisih (Karantina)</p>
          <p className="text-2xl font-black text-danger-600 mt-1">{pendingDiscrepancies.length}</p>
        </div>
