...
const Logo = (
  <div style={{ background: '#111', width: 44, height: 44, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '1.15rem', marginBottom: '0.75rem', border: '1px solid #333' }}>GH</div>
);

const Footer = (
  <div style={{ marginTop: '0.85rem', fontSize: '0.75rem', color: '#666', lineHeight: 1.5, textAlign: 'center' }}>
    By proceeding, you agree to creating an account
    <br />
    subject to our <a href="#" style={{ color: '#888' }}>Terms of Service</a> and <a href="#" style={{ color: '#888' }}>Privacy Policy</a>.
  </div>
);
        ...
        {isLogin ? (
          <div style={{ width: '100%', maxWidth: 360, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            <form onSubmit={handleLogin} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
              ...
              <button type="submit" style={{ width: '100%', padding: '0.65rem', borderRadius: 6, border: 'none', background: '#ededed', color: '#000', fontWeight: 500, fontSize: '0.875rem', cursor: 'pointer' }}>
                {!showPassword ? 'Continue with Email' : submitting ? 'Signing in…' : 'Sign in with Password'}
              </button>
              {showPassword && (
                <button
                  type="button"
            ...
            <button type="button" style={socialBtn} onClick={() => alert('OAuth Google belum dikonfigurasi. Gunakan email + password.')}>{GoogleIcon}Continue with Google</button>
            <button type="button" style={socialBtn} onClick={() => alert('OAuth GitHub belum dikonfigurasi. Gunakan email + password.')}>{GitHubIcon}Continue with GitHub</button>
            <button type="button" style={{ ...socialBtn, marginBottom: 0 }} onClick={() => alert('OAuth Apple belum dikonfigurasi. Gunakan email + password.')}>{AppleIcon}Continue with Apple</button>
          ...
          <div style={{ width: '100%', maxWidth: 360, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); alert('Pendaftaran akun baru hanya dilakukan oleh Superadmin. Silakan login dengan akun yang sudah dibuat.'); }} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
            ...
            <button type="button" style={socialBtn} onClick={() => alert('OAuth Google belum dikonfigurasi.')}>{GoogleIcon}Sign up with Google</button>
            <button type="button" style={socialBtn} onClick={() => alert('OAuth GitHub belum dikonfigurasi.')}>{GitHubIcon}Sign up with GitHub</button>
            <button type="button" style={{ ...socialBtn, marginBottom: 0 }} onClick={() => alert('OAuth Apple belum dikonfigurasi.')}>{AppleIcon}Sign up with Apple</button>
